...
async def topgg():
    ...
    webhook_data = {
        "username": "SB Moderation",
        "content": f"<@{user_id}> voted for <@1144179659735572640>!",
        "embeds": [
            {
                "description": "**[Voted SB Moderation](https://top.gg/bot/1144179659735572640)**\n💖 Thank you for voting for SB Moderation on Top.gg, your support means everything to us!\n",
                "fields": [
                ...
                "footer": {
                    "text": f"Voter ID: {user_id} | SB Moderation™ | {footer_time}",
