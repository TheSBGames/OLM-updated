...
from core import SB Moderation
...
########-------HELP-------########
from .SB Moderation.antinuke import _antinuke
from .SB Moderation.extra import _extra
from .SB Moderation.general import _general
from .SB Moderation.automod import _automod 
from .SB Moderation.moderation import _moderation
from .SB Moderation.music import _music
from .SB Moderation.fun import _fun
from .SB Moderation.games import _games
from .SB Moderation.ignore import _ignore
from .SB Moderation.server import _server
from .SB Moderation.voice import _voice 
from .SB Moderation.welcome import _welcome 
from .SB Moderation.giveaway import _giveaway
...
async def setup(bot: SB Moderation):
  cogs_to_load = [
