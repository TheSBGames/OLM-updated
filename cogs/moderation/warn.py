...
class Warn(commands.Cog):
    ...
    async def warn(self, ctx, user: discord.Member, *, reason=None):
        ...
        try:
            ...
            embed = discord.Embed(description=f"**<:SB ModerationUser:1294654665895579721> Target User:** [{user}](https://discord.com/users/{user.id})\n"
                                              ...
                                              f"**<:SB ModerationArrow:1297341001341599797> Reason:** {reason_to_send}\n"
                                              f"**<:SB ModerationQuesMark:1297341037752221747> Total Warns:** {total_warns}",
                                              color=self.color)
    ...
    async def clearwarns(self, ctx, user: discord.Member):
        try:
            ...
            embed = discord.Embed(description=f"<:SB Moderation_tick:1227866641027698792> | All warnings have been cleared for **{user}** in this guild.", color=self.color)
