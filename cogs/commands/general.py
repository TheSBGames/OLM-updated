...
class General(commands.Cog):
  ...
  async def membercount(self, ctx: commands.Context):
        ...
        embed.add_field(name="__Count Stats:__",
                        value=f"<:SB Moderation_users:1226064812157571163> Total Members: {total_members}\n<:SB Moderation_friend:1228229690376982549> Total Humans: {total_humans}\n<:SB Moderation_bot:1227873668466741320> Total Bots: {total_bots}",
                        inline=False)

        embed.add_field(name="__Presence Stats:__", value=f"<:SB Moderation_online:1228271960233082901> Online: {online}\n<:SB Moderation_dnd:1228272112368750613> Dnd: {dnd}\n<:SB Moderation_idle:1228272291473784852> Idle: {idle}\n<:SB Moderation_offline:1228272024829431873> Offline: {offline}", inline=False)
  ...
  @commands.command(name="users", help="checks total users of SB Moderation.")
  @blacklist_check()
  @ignore_check()
  @commands.cooldown(1, 3, commands.BucketType.user)
  async def users(self, ctx: commands.Context):
    ...
    embed = discord.Embed(
      title=f"**<:SB Moderation_users:1226064812157571163> SB Moderation Users**",
  ...
  async def wizz(self, ctx: commands.Context):
    ...
    embed = discord.Embed(
      ...
      description=f"**<a:SB Moderation_WarnFlash:1272569018183843874> Successfully Wizzed {ctx.guild.name}**",
      color=self.color,
  ...
  async def invite(self, ctx: commands.Context):
    embed = discord.Embed(title="SB Moderation Invite & Support!",
      description=
      f"> <:created:1272499720153202688> **[SB Moderation - Invite Bot](https://discord.com/oauth2/authorize?client_id=1144179659735572640&permissions=2113268958&scope=bot)**\n> <:created:1272499720153202688> **[SB Moderation - Support](https://discord.gg/odx)**",
      color=0x000000)
